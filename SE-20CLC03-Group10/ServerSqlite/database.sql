...
(
	IDOrder char(5) NOT NULL PRIMARY KEY,
	...
	UserName char(20),
	VoucherName char(10),
    CONSTRAINT FK_B_ORDER_BUYER
    FOREIGN KEY (UserName)
    REFERENCES BUYER(UserName)
    
    CONSTRAINT FK_B_ORDER_VOUCHER
...
(
    ...
    CONSTRAINT FK_B_ORDERDETAIL_STORE
    FOREIGN KEY (StoreName,FoodName)
    REFERENCES STORE(StoreName,FoodName)
    CONSTRAINT FK_B_ORDERDETAIL_B_ORDER
    FOREIGN KEY (IDOrder)
...
INSERT INTO FOOD VALUES ('Cơm sườn',NULL);
...
INSERT INTO B_ORDER VALUES('OD001','Nguyễn','A','Số 3, đường 2','Quận 3','Tp.HCM','0123456789','không ớt',5.000,20.000,85.000,'Customer1','SHOPAA1');
INSERT INTO B_ORDER VALUES('OD002','Nguyễn','Bình','Số 8, đường 10','Quận 1','Tp.HCM','0123456788','cho nhiều rau',10.000,20.000,50.000,'Customer3','SHOPAA1');
INSERT INTO B_ORDER VALUES('OD003','Nguyễn','Công','Số 7, đường 7','Quận 7','Tp.HCM','0123456787','không ớt',20.000,0,120.000,'Customer5',NULL);
INSERT INTO B_ORDER VALUES('OD003','Nguyễn','Công','Số 7, đường 7','Quận 7','Tp.HCM','0123456787','không ớt',20.000,0,120.000,'Customer5',NULL);
